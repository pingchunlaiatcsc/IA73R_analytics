...
SUB XLS1
	...
	XL.CELLS(5,5).VALUE = "=SUMIFS(IA73!U:U,IA73!S:S,""90"",IA73!X:X,""內銷"",IA73!A:A,"" "")/1000"
	...
	XL.CELLS(5,6).VALUE = "=SUMIFS(IA73!U:U,IA73!S:S,""90"",IA73!X:X,""外銷"",IA73!A:A,"" "")/1000"
	...
	XL.CELLS(5,7).VALUE = "=SUMIFS(IA73!W:W,IA73!S:S,""90"",IA73!A:A,"" "",IA73!X:X,""內銷"")/1000"
	...
	XL.CELLS(5,8).VALUE = "=SUMIFS(IA73!W:W,IA73!S:S,""90"",IA73!A:A,"" "",IA73!X:X,""外銷"")/1000"
	...
	XL.CELLS(5,10).VALUE = "=SUMIFS(IA73!U:U,IA73!S:S,""90"",IA73!X:X,""內銷"",IA73!AC:AC,""S355M*"",IA73!AF:AF,"""")/1000"
	XL.CELLS(6,10).FormulaR1C1 = "=SUM(R[-4]C:R[-1]C)"
	XL.CELLS(7,10).FormulaR1C1 = "=R[-1]C/R5C2"
